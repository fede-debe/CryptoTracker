...
/** Using the same [CoinListState] of the [CoinListScreen]
 * since it has a selectedCoin value.
 * */
        ...
        Column(
            ...
            FlowRow(
                ...
                val contentColor = when {
                    coin.hasPositiveTrend -> if (isSystemInDarkTheme()) Color.Green else greenBackground
                    else -> MaterialTheme.colorScheme.error
                }
                val trendIcon = when {
                    coin.hasPositiveTrend -> ImageVector.vectorResource(R.drawable.trending)
